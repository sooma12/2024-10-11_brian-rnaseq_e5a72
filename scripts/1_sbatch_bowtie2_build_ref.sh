...
#SBATCH --output=/scratch/soo.m/2024-10-11_brian-rnaseq_e5a72/logs/%x-%j.log
#SBATCH --error=/scratch/soo.m/2024-10-11_brian-rnaseq_e5a72/logs/%x-%j.err
...
echo "Genome fasta files: $REF_CHR_FA, $REF_P1_FA, $REF_P2_FA"

echo "Basename of output: $BT2_OUT_BASE"
#echo "Directory for Bowtie2 genome index: $GENOME_INDEX_DIR"

bowtie2-build -f --threads 4 $REF_CHR_FA,$REF_P1_FA,$REF_P2_FA $BT2_OUT_BASE
